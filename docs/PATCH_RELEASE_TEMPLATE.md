...
- [ ] Cut a release on [github](https://github.com/spknetwork/kubo/releases) and reuse signed artifacts from https://dist.ipfs.tech/kubo (run [sync-release-assets.yml workflow](https://github.com/spknetwork/kubo/actions/workflows/sync-release-assets.yml)).
...
- [ ] Release published
  ...
  - [ ] to [github](https://github.com/spknetwork/kubo/releases)
