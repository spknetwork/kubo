...
**REMOVED**: this option is [no longer necessary](https://github.com/spknetwork/kubo/pull/9481). Ignored since  [Kubo 0.18](https://github.com/spknetwork/kubo/blob/master/docs/changelogs/v0.18.md).
