...
import (
	...
	repo "github.com/spknetwork/kubo/repo"
	"github.com/spknetwork/kubo/repo/common"
	dir "github.com/spknetwork/kubo/thirdparty/dir"
	...
	serialize "github.com/spknetwork/kubo/config/serialize"
...
func (r *FSRepo) openDatastore() error {
	...
	if r.config.Datastore.NoSync {
		log.Warn("NoSync is now deprecated in favor of datastore specific settings. If you want to disable fsync on flatfs set 'sync' to false. See https://github.com/spknetwork/kubo/blob/master/docs/datastores.md#flatfs.")
	}
...
// https://github.com/spknetwork/kubo/issues/8088 for more details).
